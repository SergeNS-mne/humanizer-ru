...
1. **Фразовый слой** — каталог из 50+ правил в 8 тематических группах: контентные паттерны, языковые, стилевые, типография, коммуникация, **морфология** (для RuBERT-маркеров), **расширенная идиоматика** (4 класса калек), филлеры.
2. **Документный слой** — структурная диагностика: listicle-сигнатура, плотность тире, разброс длин предложений, доля AI-цитат, голосовая консистентность с паспортом.
...
2. Сократить блоки AI-цитат до инлайн-формы («AI пишет „...“, человек — „...“»).
3. Тире — заменить большую часть на запятые/двоеточия.
...
Морфологическая равномерность — то, что RuBERT-классификаторы дополнительно проверяют сверх фразовых паттернов. AI ошибается в морфологии иначе, чем люди: люди путают «-тся/-ться», AI путает падежи в длинных цепочках, нарушает согласование рода в составных подлежащих, использует деепричастия не к тому подлежащему.
...
Прогоняем диагностику S1-S6. Если есть критические маркеры — **сообщаем автору и спрашиваем**:
...
Честное позиционирование (см. README): скилл работает на уровне **фраз и документной структуры**. Он не гарантирует прохождение статистических детекторов LLM-текста (GPTZero, Originality.ai, Хабровский НЛО, RuBERT-классификаторы).
