...
**Маркер AI:** автоматическое длинное тире `—` с пробелами.

**Реальность:**
- В книгах / официальных текстах — `—` с пробелами (по Розенталю)
- В онлайн-контенте, блогах, Telegram, email — чаще `–` или просто `-`
- В неформальной переписке — `-` с пробелами

**Правило калибровки:** подобрать из примера автора, какой символ и частоту использует. Не навязывать длинное тире.
...
- [Нора Галь. «Слово живое и мёртвое»](https://ru.wikipedia.org/wiki/Слово_живое_и_мёртвое) — классика про канцелярит и кальки
- [Максим Ильяхов. «Пиши, сокращай»](https://ilyahov.ru/) — правила чистки инфостиля (местами пересекается с humanizer)
